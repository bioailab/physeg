...
from helper_generator_v5 import generate_save_vesicles, get_config, save_physics_gt, save_physics_gt_rgb
...
def generate_vesicles(batch, number, nlow, nhigh):
    ...
    # System parameters
    step_size_xy = 0.08  # [um] pixel size
    ...
    for t in range(size_t):
        ...
        if(t==0):
            ...
            save_physics_gt(particlesArray, batch, number, 80, 128, 2560) # todo: replace last 3 parameters
